...
#ifndef E__CFS_SIA3D_SRC_CONFIG_PHYSICS_CONFIGURATION_HPP
#define E__CFS_SIA3D_SRC_CONFIG_PHYSICS_CONFIGURATION_HPP
...
class PhysicsConfiguration: public ::xml_schema::type
{
  public:
  // Component
  //
...
class Parameter: public ::xsd::cxx::tree::fundamental_base< ::xml_schema::double_, char, ::xml_schema::simple_type, ::xsd::cxx::tree::schema_type::double_ >
{
  public:
  // name
  //
  ...
  // Constructors.
  //
  Parameter (const ::xml_schema::double_&,
             const name_type&);
...
::std::unique_ptr< ::PhysicsConfiguration >
Physics (::xercesc::InputSource& is,
         ::xml_schema::flags f = 0,
         const ::xml_schema::properties& p = ::xml_schema::properties ());
...
::std::unique_ptr< ::PhysicsConfiguration >
Physics (const ::xercesc::DOMDocument& d,
         ::xml_schema::flags f = 0,
         const ::xml_schema::properties& p = ::xml_schema::properties ());
...
#endif // E__CFS_SIA3D_SRC_CONFIG_PHYSICS_CONFIGURATION_HPP
