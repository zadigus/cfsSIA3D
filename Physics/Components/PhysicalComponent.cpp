...
PhysicalComponent::PhysicalComponent(Component* aComponent) // , std::unique_ptr<PhysicsCoreConfiguration>& aPhysCoreConf/*std::shared_ptr<PhysicsConfiguration>& physConf, std::string compName*/ /*unsigned int N*/)
