...
#	SET (XERCES_ROOT /usr)
#ELSEIF(WIN32)
	IF(EXISTS $ENV{XERCES_ROOT}) #TODO: double-check if that also works under Unix
		SET(XERCES_ROOT $ENV{XERCES_ROOT})
	ENDIF()
#ENDIF()

FIND_PATH(XERCES_INCLUDE_DIRS xercesc/util/XercesVersion.hpp
	PATH ${XERCES_ROOT}/include)
...
IF(XERCES_FOUND)
	MESSAGE(STATUS "Xerces found at ${XERCES_ROOT}")
ELSE()
